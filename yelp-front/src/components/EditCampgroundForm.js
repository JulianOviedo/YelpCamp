...
export default function EditCampgroundForm ({ id, title, location, imageUrl, price, description }) {
                ...
                <form action={`${BASE_URL}/campgrounds/${id}?_method=PUT`} method="POST">
                    ...
                    <div className="mb-3">
                        ...
                        <div className="input-group">
                            ...
                            <input type="text" className="form-control" id="price" placeholder="0.00" aria-label="price"
                                aria-describedby="price-label" name="campground[price]" value={price}/>
                        </div>
                    </div>
                    ...
                    <div className="mb-3">
                        ...
                        <textarea className="form-control" type="text" id="description"
                            name="campground[description]" value={description}></textarea>
                    </div>
                    <div className="mb-3">
